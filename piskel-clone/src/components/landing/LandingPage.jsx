  ...
  return (
    <div className="landing">
      <div className="landing-overview">
        <h4>
          This app is a variation of the famous
          <a href="http://piskelapp.com">PISKEL</a>
      ...
      <div className="landing-screen">
        <img src="src/assets/landing.jpg" alt="landing" width="500" height="300" />
      </div>
      <section className="landing-gifs">
        <img src="src/assets/1.gif" alt="gif1" width="250" height="200" />
        <img src="src/assets/2.gif" alt="gif2" width="250" height="200" />
        <img src="src/assets/3.gif" alt="gif3" width="200" height="200" />
        <img src="src/assets/4.gif" alt="gif4" width="200" height="200" />
      </section>
      <footer className="landing-footer">
        {' '}
        <h5>
          2020, Dmitrij Nikitin.
          <a href="https://dmnikitin.github.io/portfolio/">portfolio</a>
        </h5>
      </footer>
    </div>
  );
